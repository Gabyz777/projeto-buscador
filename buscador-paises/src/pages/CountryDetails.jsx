            ...
            <div className={styles.container}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.infoContainer}>
                        ...
                        <p className={styles.officialName}>{officialName}</p>
                        ...
                        <div className={styles.detailsList}>
                            <div className={styles.detailItem}>
                                <strong className={styles.detailLabel}>👥 População:</strong>{' '}
                                <span className={styles.detailValue}>{population} habitantes</span>
                            </div>
                            <div className={styles.detailItem}>
                                <strong className={styles.detailLabel}>🗣️ Idiomas:</strong>{' '}
                                <span className={styles.detailValue}>{languages}</span>
                            </div>
                            <div className={styles.detailItem}>
                                <strong className={styles.detailLabel}>💰 Moeda:</strong>{' '}
                                <span className={styles.detailValue}>{currencies}</span>
                            </div>
                            <div className={styles.detailItem}>
                                <strong className={styles.detailLabel}>🕒 Fuso Horário:</strong>{' '}
                                <span className={styles.detailValue}>{country.timezones?.[0]}</span>
                            </div>
                        </div>
                    </div>
                </div>
